...
- [x] landing page (ay fazi, yildizlar, navigasyon)
- [x] ios project setup (swiftui, xcode, xcodegen)
- [x] data models (moon phase enum, astro event model)
- [x] moon phase calculation (local astronomical algorithm)
- [x] location manager (cllocationmanager wrapper)
- [x] home view with moon scene, moon info card, cosmic events list
- [x] animated cloud layers with parallax drift
